...
| Imported logs & element paths         | Page Workflow Hook   | `src/hooks/useTimelineImports.ts` (called by `WorkspacePage`)                                                              |
